...
function Crest() {
  return (
    <div className="crest" aria-label="Emblema do projeto BAEP 18º BPM/M Virtual">
      <div className="crest-top">18º BPM/M</div><div className="crest-star">★</div><div className="crest-baep">BAEP</div>
      <div className="crest-lines"><i /><i /><i /></div><div className="crest-bottom">VIRTUAL</div>
    </div>
  );
}
